...
export async function sendEmail(email: string, firstname: string, res: MyTest, urls: string[], listname: string) {
                ...
                <td style="padding:0; font-family:Arial,sans-serif; text-align:center; line-height:1.5em; font-size:1.5em; color:#333; font-weight:200;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0 auto;">
                        <tbody>
                            ...
                            <tr>
                                <td style="padding:10px; font-family:Arial,sans-serif; text-align:left; color:#333; font-weight:600;">Nome da lista</td>
                                <td style="padding:10px; font-family:Arial,sans-serif; text-align:left; color:#333; font-weight:600;">${listname}</td>
                            </tr>
                            <tr>
